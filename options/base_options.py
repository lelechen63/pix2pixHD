...
class BaseOptions():
    ...
    def initialize(self):    
        ...
        # for setting inputs
        self.parser.add_argument('--dataroot', type=str, default="/home/cxu-serve/p1/lchen63/voxceleb") 
        ...
        self.parser.add_argument('--use_deform', type=bool, default=False, help='use deform')
