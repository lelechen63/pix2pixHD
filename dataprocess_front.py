...
#     ff = np.load('/data/lchen63/grid/zip/video/s20/video/mpg_6000/bbad3n.npy')[0]
    ...
    srt_path = video_path[:-4] +  '_sRT_front.npy'
    front_path =video_path[:-4] +  '_front.npy'
    
    t_lmark = np.load(front_path)
...
def get_animation(  obj_path= None, reference_prnet_lmark_path= None, img_path = None,  \
    ...
    if video_path != None:
        ...
        rt_path  = video_path[:-4] + '_sRT_front.npy'
    ...
    if video_path != None: 
        command = 'ffmpeg -framerate 25 -i '  + temp_path + '/%5d.png  -c:v libx264 -y -vf format=yuv420p ' +   video_path[:-4] + '_ani_front.mp4'
    else:
        command = 'ffmpeg -framerate 25 -i '  + temp_path + '/%5d.png  -c:v libx264 -y -vf format=yuv420p ' +   img_path[:-4] + '_ani_front.mp4'
    os.system(command)
