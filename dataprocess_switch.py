...
def get_animation(  obj_path= None, reference_prnet_lmark_path= None, img_path = None,  \
    ...
    if video_path != None:
        ...
        rt_path = '/home/cxu-serve/p1/lchen63/voxceleb/unzip/test_prediction_video3/id01822/00003_sRT.npy'
        lmark_path  = video_path[:-4] +'_front.npy'
        ani_path = video_path[:-4] + '_id01822_00003_ani_.mp4'
...
convert_folder('/home/cxu-serve/p1/lchen63/voxceleb/unzip/test_prediction_video3/')
